...
const DotMaterial = shaderMaterial(
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      // Mouse trail effect - enhanced for darker streaks
      float mouseInfluence = texture2D(mouseTrail, gridUvCenterInScreenCoords).r;
      
      // Increased influence for more visible effect
      ...
      float sdfDot = sdfCircle(gridUv, dotSize * (1.0 + scaleInfluence * 0.8));

      float smoothDot = smoothstep(0.05, 0.0, sdfDot);

      // Enhanced opacity influence for darker streaks
...
function Scene() {
    ...
    // Force light mode with white background and dark hover streaks
    const themeColors = {
        dotColor: '#666666', // Gray dots that darken on hover
        bgColor: '#FFFFFF', // Pure white background
        dotOpacity: 0.2 // Increased opacity for visibility
    }
